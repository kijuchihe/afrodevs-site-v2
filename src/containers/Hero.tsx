...
import FadeRight from "../animation components/FadeRIght";
	...
	return (
		<section>
			<div className="flex flex-col gap-12 pb-8 px-5 c-container md:flex-row pt-[142px] md:pt-[174px] md:gap-0 md:pb-16 md:justify-between lg:pb-20 lg:pt-[190px]">
				...
				<FadeRight
					delay={0.5}
					className="flex justify-center md:-mt-6 lg:w-1/2 lg:justify-end max-w-xl mx-auto md:mx-0 w-full md:max-w-none md:w-auto"
				>
					<img
						src={heroImg}
						alt="hero image"
