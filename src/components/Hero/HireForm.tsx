					...
					<div className="fixed w-[90%] max-w-lg p-4 mx-auto bg-white z-[100] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl">
						...
						<form onSubmit={handleSubmit} className="space-y-4">
							<div className="space-y-2">
								...
								<div className="px-2 py-1 border border-gray-200 rounded-md focus-within:border-gray-400">
									<input
										type="text"
										id="name"
										name="name"
							...
							<div className="space-y-2">
								...
								<textarea
									...
									rows={5}
									className="inline-block w-full px-2 py-1 border border-gray-200 rounded-md outline-none focus:border-gray-400"
